...
import CompaniesListClient from './companies-list';
import { nbrEmployeFilterOptions } from '@/utils/rawData';
...
describe('CompaniesListClient', () => {
	...
	describe('Rendering', () => {
		it('renders navigation bar with title', () => {
		...
		it('renders Nouvelle entreprise button', () => {
			render(<CompaniesListClient session={mockSession} />);
	...
	describe('Action handlers', () => {
		...
		it('handles suspend error', async () => {
			...
			await waitFor(() => {
				expect(mockOnError).toHaveBeenCalledWith('Erreur lors de la suspension');
			});
		});
	});
	...
	describe('Loading and empty states', () => {
		it('renders when loading', () => {
			mockUseGetCompaniesListQuery.mockReturnValueOnce({
	...
	describe('Exports', () => {
		it('defines nbrEmployeFilterOptions', () => {
