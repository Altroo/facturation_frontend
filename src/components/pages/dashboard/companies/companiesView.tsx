						...
						<Stack spacing={3}>
										...
										<Stack spacing={2} sx={{ flex: 1, width: '100%' }}>
											<Stack spacing={1} alignItems={isMobile ? 'center' : 'flex-start'}>
												...
												<Stack direction="row" spacing={1} alignItems="center" flexWrap="wrap">
													<Chip icon={<BadgeIcon />} label={`ID: ${companyData?.id}`} size="small" variant="outlined" />
							...
							<Card elevation={2} sx={{ borderRadius: 2 }}>
								<CardContent sx={{ p: 3 }}>
									...
									<Divider sx={{ mb: 2 }} />
									<Stack spacing={0}>
										<InfoRow icon={<CalendarTodayIcon />} label="Date de création" value={companyData?.date_created} />
										<Divider />
