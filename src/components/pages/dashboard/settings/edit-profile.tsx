...
import type { formikContentType } from '@/types/dashboardTypes';
			...
			<form className={Styles.form} onSubmit={(e) => e.preventDefault()}>
				...
				>
					...
					<CustomTextInput
						...
						placeholder={t.settings.fieldEmail}
						theme={inputTheme}
					...
					<CustomTextInput
						...
						fullWidth={true}
						size="small"
						label={t.settings.fieldNom}
						placeholder={t.settings.fieldNom}
						theme={inputTheme}
					...
					<CustomTextInput
						...
						fullWidth={true}
						size="small"
						label={t.settings.fieldPrenom}
						placeholder={t.settings.fieldPrenom}
						theme={inputTheme}
						startIcon={<PersonIcon fontSize="small" />}
						cssClass={Styles.maxInputWidth}
					/>
					...
					<PrimaryLoadingButton
						buttonText={t.settings.updateBtn}
						active={!isPending}
...
const EditProfilClient: FC<SessionProps> = (props: SessionProps) => {
	...
	return (
		<Stack direction="column" sx={{ position: 'relative' }}>
			<NavigationBar title={t.settings.navbarTitle}>
