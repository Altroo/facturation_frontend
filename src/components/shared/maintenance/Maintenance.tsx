	...
	return (
		...
		>
			...
			>
				...
				>
					<Image src={Logo} alt={t.maintenance.logoAlt} priority style={{ width: '150px', height: 'auto' }} />
				...
				>
					...
					>
						<Image src={Logo} alt={t.maintenance.logoAlt} priority style={{ width: '88px', height: 'auto' }} />
					</Stack>
