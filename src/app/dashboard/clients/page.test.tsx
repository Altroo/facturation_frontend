...
describe('ClientsListPage server component', () => {
	...
	it('renders ClientsListClient with session and archived=false when session exists', async () => {
		const sessionValue: Session = { user: { pk: 77, email: 'client@site.com' } };
