...
// mock ArticlesListClient
jest.mock('@/components/pages/dashboard/articles/articlesList', () => ({
	__esModule: true,
...
describe('ArticlesArchivedListPage server component', () => {
	...
	it('renders ArticlesListClient with session and archived=true when session exists', async () => {
