...
describe('ArticlesListPage server component', () => {
	...
	it('renders ArticlesListClient with session and archived=false when session exists', async () => {
		const sessionValue: Session = { user: { pk: 77, email: 'article@site.com' } };
