...
// mock CompaniesViewClient
jest.mock('@/components/pages/dashboard/companies/CompaniesView', () => ({
	__esModule: true,
...
describe('CompaniesViewPage server component', () => {
	...
	it('renders CompaniesViewClient with session and id when session exists', async () => {
		...
		expect(decoded).toContain('ID=654');
