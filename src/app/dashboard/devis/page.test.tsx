...
jest.mock('@/components/pages/dashboard/devis/devisList', () => ({
	__esModule: true,
	default: (props: { session?: Session }) => {
		// eslint-disable-next-line @typescript-eslint/no-require-imports
		const React = require('react');
		return React.createElement('div', null, `DEVIS_LIST_CLIENT_MARKER:${JSON.stringify(props?.session ?? null)}`);
	},
}));
...
describe('DevisListPage server component', () => {
	...
	it('renders DevisListClient with session when session exists', async () => {
