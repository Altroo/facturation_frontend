...
// mock DevisForm
jest.mock('@/components/pages/dashboard/devis/devisAddForm', () => ({
	__esModule: true,
	default: (props: { session?: Session; company_id?: number }) => {
		...
		return React.createElement(
			'div',
			null,
			`DEVI_FORM_MARKER:${JSON.stringify(props?.session ?? null)}:COMPANY_ID=${props?.company_id ?? ''}`,
		);
	},
}));
...
describe('DeviNewCompanyIDPage server component', () => {
