...
// Mock client components used by the server page
...
// Mock the ClearCookiesClient which in production is a client component that runs an effect.
// In server tests we render a marker element instead.
